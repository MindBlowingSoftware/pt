      ...
      <table className='table'>
        <thead>
          <tr>
            ...
            <th><p className="text-right">P/L %</p></th>
            <th><p className="text-right">10</p></th>
            <th><p className="text-right">100</p></th>                      
            <th><p className="text-right">1000</p></th>
          </tr>
        </thead>
        <tbody>
                  {
                      savings.map(item =>
                          <tr key={item.id} className={item.amount - item.amountInvested >= 0 ? 'text-right bg-success' : 'text-right bg-danger'}>
                              ...
                              <td>
                                  <Sparklines data={item.amountHistory} limit={20} width={100} height={20} margin={5}><SparklinesLine /></Sparklines>
                              </td> 
                              <td>
                                  <Sparklines data={item.amountHistory} limit={100} width={100} height={20} margin={5}><SparklinesLine /></Sparklines>
                              </td> 
                          </tr>
                      )}
